...
def load_image(image_path = '/content/drive/MyDrive/Academic_Courses_and_ML_Projects/Paper_Publications_Files/Paper_3/Annotated_Images/Annotated_Dataset/Malignant/Folder_37_3_1_img6.jpg'):
...
def plot_output(image, heatmap, output):
